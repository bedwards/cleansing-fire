---
description: Implement a feature following the Cleansing Fire development workflow (issue → branch → code → PR)
---

# Implement a Feature

Follow the definitive development loop from `CLAUDE.md`.

## Steps

1. **Read `CLAUDE.md`** to understand project conventions
2. **Search GitHub Issues** for an existing issue matching the request
